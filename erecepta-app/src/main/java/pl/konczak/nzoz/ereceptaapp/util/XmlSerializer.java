...
public class XmlSerializer {
    ...
    public String clinicalDocumentToXml(final ClinicalDocument clinicalDocument) {
        ...
        try {
            ...
            log.error("Failed to marshal object <{}> to XML because of JAXBException", e);
            throw new RuntimeException(e);
        }
        return result;
    }

    public void clinicalDocumentToFile(final ClinicalDocument clinicalDocument, final String file) {
        try {
            JAXBContext jaxbContext = JAXBContext.newInstance(ClinicalDocument.class);
            Marshaller jaxbMarshaller = jaxbContext.createMarshaller();
            ...
            log.error("Failed to marshal object <{}> to XML because of IOException", e);
            throw new RuntimeException(e);
        }
    }
